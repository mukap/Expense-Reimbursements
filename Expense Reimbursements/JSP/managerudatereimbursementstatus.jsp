...
<div class="center">
<h3>UPDATE REIMBURSEMENT REQUEST FORM</h3>
<form action="ManagerUpdateReimbStatusServlet" method="post">
<input type="text" name="emp_id" placeholder="EMPLOYEE ID"><br>
<input type="text" name="emp_status" placeholder="APPROVED or DINY"><br>

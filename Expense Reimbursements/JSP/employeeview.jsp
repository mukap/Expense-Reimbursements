...
<body>
	...
	<jsp:setProperty property="*" name="obj" />
		...
		<%
		List<Employee> list = EmployeeDao.getAllEmpPlofileInfo();
...
ID : ${e.getEmp_id()}<br>
USER NAME : ${e.getEmp_name()}<br>
EMAIL : ${e.getEmp_email()}<br>
PHONE : ${e.getEmp_mob()}<br>
PASSWORD : ${e.getEmp_pass()}<br>
</c:forEach>


<br> <br><a class="button" href="employeeeditinformation.jsp">Edit</a>
		<br> <br><a href="employeehomepage.jsp" class="button">BACK</a>
